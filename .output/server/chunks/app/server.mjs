import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, useSSRContext, hasInjectionContext, unref, inject, defineComponent, computed, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, createApp, reactive, toRef, isRef, onServerPrefetch, provide, onErrorCaptured, h, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { h as useRuntimeConfig$1, n as withQuery, o as hasProtocol, p as parseURL, q as isScriptProtocol, j as joinURL, k as createError$1, r as klona, $ as $fetch, t as sanitizeStatusCode, v as createHooks, x as hash, y as isEqual, z as stringifyParsedURL, A as stringifyQuery, B as parseQuery } from '../nitro/node.mjs';
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-bb56823a.mjs').then((r) => r.default));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9c34c54e"]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ea739b84"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    var _a;
    let __temp, __restore;
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/healthcheck", "$siNM9WAguS")), __temp = await __temp, __restore(), __temp);
    const statusText = data ? `API Status: ${(_a = data.value) == null ? void 0 : _a.healthcheck}` : "API Status: Unknown";
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      const _component_Icon = __nuxt_component_0;
      const _component_NuxtWelcome = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="header"><div style="${ssrRenderStyle({ "flex-direction": "column", "display": "flex" })}"><h1> Welcome to Nuxt on <img src="https://getampt.com/images/ampt.svg" class="logo"></h1><div class="status"><div class="icon-container">`);
      if (((_a2 = unref(data)) == null ? void 0 : _a2.healthcheck) === "OK") {
        ...
        _push(ssrRenderComponent(_component_Icon, {
          name: "iconoir:warning-circle",
          color: "red",
          size: "30"
        }, null, _parent));
      }
      _push(`</div><div class="text-container"><p class="status-text">${ssrInterpolate(unref(statusText))}</p></div></div></div><div class="tip-container"><p style="${ssrRenderStyle({ "text-align": "center" })}"> Run <code>dev</code> in the Ampt shell to start a local server </p><p style="${ssrRenderStyle({ "text-align": "center" })}"> Run <code>build</code> to sync your changes your sandbox </p><p style="${ssrRenderStyle({ "text-align": "center" })}"> Run <code>deploy $stage</code> to deploy to a permanent environment </p></div></div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-2bc1a4e9.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-8ec21170.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-86e80568.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
