...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/ben/ampt/ampt-templates/nuxt/.data/kv"}));
...
const _lazy_sySu3V = () => import('../healthcheck.mjs');
const _lazy_8AQRs7 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/healthcheck', handler: _lazy_sySu3V, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_8AQRs7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8AQRs7, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, stringifyQuery as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, listener as E, handler as F, defineEventHandler as a, send as b, setResponseStatus as c, dr as d, eventHandler as e, setResponseHeaders as f, getResponseStatus as g, useRuntimeConfig as h, getQuery as i, joinURL as j, createError$1 as k, getRouteRules as l, getResponseStatusText as m, withQuery as n, hasProtocol as o, parseURL as p, isScriptProtocol as q, klona as r, setResponseHeader as s, sanitizeStatusCode as t, useNitroApp as u, createHooks as v, wn as w, hash as x, isEqual as y, stringifyParsedURL as z };
